...
#A loop that establishes the range of images to downlaod (form above parameters). 10 is the max number of images per request, and it loops to the next ten each request
